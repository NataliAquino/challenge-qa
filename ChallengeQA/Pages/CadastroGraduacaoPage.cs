...
{
    public class CadastroAlunoGraduacao : PageObject
    {
        private readonly IWebDriver _driver;

        public CadastroAlunoGraduacao(IWebDriver driver)
        {
            _driver = driver;
        }
        ...
        public void SelecionarCurso(string curso)
        {
            ...
            // var botaoAvancar = wait.Until(SeleniumExtras.WaitHelpers.ExpectedConditions.ElementToBeClickable(By.CssSelector("button[data-testid='next-button']")));
    ...
    //        PreencherCampo("birthdate-input", dataNsc);
        ...
        // {
        //     // Espera o campo estar visível e interagível, se quiser.
        //     var dia = Driver.FindElement(CampoDia);
        //     var mes = Driver.FindElement(CampoMes);
        //     var ano = Driver.FindElement(CampoAno);

        //     string diaStr = data.Substring(0, 2);
        //     string mesStr = data.Substring(2, 2);
        //     string anoStr = data.Substring(4, 4);

        //     // Limpa e digita (por segurança)
        //     dia.Clear(); dia.SendKeys(diaStr);
        //     mes.Clear(); mes.SendKeys(mesStr);
        //     ano.Clear(); ano.SendKeys(anoStr);
        // }
